...
MERGE INTO &DB_NAME.SILVER.DIM_CUSTOMERS AS TGT
USING (
    ...
    SELECT DISTINCT 
        ...
        'UNKNOWN' AS SIGNUP_SOURCE,
        'UNKNOWN' AS IS_ACTIVE
    FROM &DB_NAME.SILVER.SLV_TRANSACTIONS F
...
MERGE INTO &DB_NAME.SILVER.DIM_PRODUCT AS TGT
USING (
    -- Statisc rows by dimension
...
MERGE INTO &DB_NAME.SILVER.DIM_PAYMENTS AS TGT
USING (
    -- Statisc rows by dimension
...
MERGE INTO &DB_NAME.SILVER.DIM_ORDER AS TGT
USING (
    -- Statisc rows by dimension
