...
INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.FACT_TRANSACTIONS
SELECT TRANSACTION_ID,  ------------ PRIMARY KEY
    ...
    QUANTITY,
    PAYMENT_AMOUNT
FROM PROJECT_SEMESTRUCTURED.SILVER.SLV_TRANSACTIONS
;
...
INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.DIM_CUSTOMERS
SELECT * 
FROM PROJECT_SEMESTRUCTURED.SILVER.DIM_CUSTOMERS ;

/* ============================================================
   03 - PRODUCT DIMENSION
   ============================================================ */

INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.DIM_PRODUCT
SELECT *
FROM PROJECT_SEMESTRUCTURED.SILVER.DIM_PRODUCT ;
...
INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.DIM_ORDER
SELECT ORDER_ID,
    ORDER_DATE,
    ORDER_STATUS,
    CHANNEL
FROM PROJECT_SEMESTRUCTURED.SILVER.DIM_ORDER ;

/* ============================================================
   05 - PAYMENT DIMENSION
   ============================================================ */
   
INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.DIM_PAYMENT
SELECT 
    PAYMENT_ID,
    ORDER_ID,
    PAYMENT_METHOD,
    CURRENCY,
    STATUS
FROM PROJECT_SEMESTRUCTURED.SILVER.DIM_PAYMENTS 
;
...
INSERT INTO PROJECT_SEMESTRUCTURED.GOLD.FACT_ORDER_GAPS
SELECT
    DO.ORDER_ID,
    DO.CUSTOMER_ID,
    DO.ORDER_DATE,
...
FROM PROJECT_SEMESTRUCTURED.SILVER.DIM_ORDER DO
LEFT JOIN PROJECT_SEMESTRUCTURED.SILVER.SLV_TRANSACTIONS F
    ON DO.ORDER_ID = F.ORDER_ID
LEFT JOIN PROJECT_SEMESTRUCTURED.SILVER.DIM_PAYMENTS DP
